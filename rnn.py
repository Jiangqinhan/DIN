...
def dynamic_rnn(cell, inputs, att_score=None,sequence_length=None, initial_state=None,
                dtype=None, parallel_iterations=None, swap_memory=False,
                time_major=False, scope=None):
    """Creates a recurrent neural network specified by RNNCell `cell`.
    需要修改的函数,修改方向: 添加att_score功能
...
def _dynamic_rnn_loop(cell: object,
                      inputs: object,
                      initial_state: object,
                      parallel_iterations: object,
                      swap_memory: object,
